...
summary: 'Lors de la création ou de la suppression d"un cluster ONTAP Select à l"aide des exemples de code Python, vous devez fournir un fichier JSON en entrée du script. Vous pouvez copier et modifier l"exemple JSON approprié en fonction de vos plans de déploiement.' 
---
